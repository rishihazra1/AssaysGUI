from MichaelisMenten import data_analysis
...
def michaelis_menten():
    ...
    for i in range(0, len(trial_concentrations)):
        ...
        while m < number_of_trials[i] + 1:
            ...
            velocity = abs(
                data_analysis.file_interpreter.find_velocity(start_value, start_time, end_value, end_time, enzyme_concentration, molar_extinction))
