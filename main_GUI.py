...
class BradfordAssay(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        output_text = tk.Label(self, text="", font=("Helevicta", 14))
        run_ba = tk.Button(self, text="Get Protein Concentration", bg='light green', font=("Helevicta", 15), 
                                command=lambda: BradfordAssay.internal_bradford_assay(self, protein_amount_input.get(), 
                                dilution_input.get(), absorption_input.get(), output_text))
    ...
    def internal_bradford_assay(master, protein_used, dilution, absorption, output_text):
        ...
        baselines = [['20', '0', '1.000', '1.258', '1.155'], ['15', '5', '0.750', '1.083', '1.098'], 
                        ['10', '10', '0.500', '0.728', '0.713'], ['5', '15', '0.250', '0.422', '0.402'], 
                        ['2.5', '17.5', '0.125', '0.223', '0.214'], ['0', '20', '0.000', '0', '-0.005']]
